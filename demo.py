...
fig.suptitle(
    f'Interacting Maps — {"Thesis (Martel 2019)" if USE_THESIS_VERSION else "Cook et al. 2011"}  '
    f'[{DATASET}]\n'
...
ax_R.set_title('Estimated camera rotation R (rad/frame)', fontsize=8)
...
print(f'  ω = R/dt = {net.R / FRAME_DURATION} rad/s')